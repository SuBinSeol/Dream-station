...
<html lang="en-US">
  <head>
    ...
    <title>STORY</title>
    <link rel="stylesheet" href="../../css/components.css?after">
    <link rel="stylesheet" href="../../css/icons.css?after">
    <link rel="stylesheet" href="../../css/s_responsee.css?after">
    <link rel="stylesheet" href="../../owl-carousel/owl.carousel.css?after">
    <link rel="stylesheet" href="../../owl-carousel/owl.theme.css?after">
    <link rel="stylesheet" href="../../css/lightcase.css?after">
    <link rel="stylesheet" href="../../css/main1.css?after">
    <!-- TABLE -->
  ...
  <body class="size-1280">
    ...
    <main role="main">
      ...
      <?php
        ...
        while ($stories = $sql->fetch_assoc()){
          array_push($f_index, $stories['s_index']);
          array_push($f_title, $stories['s_title']);
          array_push($f_content, $stories['s_content']);
          array_push($f_date, $stories['s_date']);
          array_push($f_view, $stories['s_view']);
          array_push($f_writer, $stories['s_writer']);
        }?>
      ...
      <div class="container">
            ...
            <tbody>
              <script>
                ...
                for(var i=0; i<j_date.length; i++){
                  ...
                  document.write('<td>'); document.write('<a href="story_views.php?data='); document.write(i+1);
        ...
        <a class="btn btn-default pull-left" href="./story_write.php" onclick="return logincheck()">글쓰기</a>
      </div>
    </div>
    ...
    <footer>
      ...
      <section class="padding-2x background-dark full-width">
        <div class="s-18 l-10">
          <img class="logo-menu" src="../../img/dream/logo123.PNG" alt=""><br>
